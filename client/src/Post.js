        ...
        <>
            <div className="post">
                ...
                <div className="text">
                    ...
                    <p className="info">
                        <a href="" className="author">Hasnain Iftikhar</a>
            ...
            <div className="post">
                <div className="image">
                    <img src="https://techcrunch.com/wp-content/uploads/2024/01/safe-living-device-on-furniture.jpg?resize=1200,900" alt="Post2"/>
                </div>
                <div className="text">
            ...
            <div className="post">
                <div className="image">
                    <img src="https://techcrunch.com/wp-content/uploads/2020/02/apple-news-ios-icon.jpg?resize=1200,675" alt="Post3"/>
                </div>
                <div className="text">
